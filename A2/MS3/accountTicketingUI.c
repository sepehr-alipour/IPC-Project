...
void menuAgent(struct AccountTicketingData* ticketingData, const struct Account* account)
{
	...
	do {
		...
		case 2:
			...
			break;
		case 3:
			deleteAccount(ticketingData, account->number);
		...
		case 8:
			...
			//accountIndex = findAccountIndexByAcctNum(ticketingData.tickets[indextTicket].accountNumber, account, ticketingData->ACCOUNT_MAX_SIZE, 0);
		...
		case 9:
			...
			manageTicket(ticketingData->tickets, ticketingData->accounts, account->person, ticketingData->TICKET_MAX_SIZE, ticketingData->ACCOUNT_MAX_SIZE);
			printf("\n");
			//pauseExecution();
			break;
		case 0:
			...
			printf("  %d accounts saved\n", loadAccounts(ticketingData->accounts, ticketingData->ACCOUNT_MAX_SIZE));
			printf("  %d tickets saved\n", loadTickets(ticketingData->tickets, ticketingData->TICKET_MAX_SIZE));
			printf("\n### LOGGED OUT ###\n\n");
			break;
		default:
